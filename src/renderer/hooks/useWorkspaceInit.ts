    ...
    async function init() {
      try {
        const [path] = await Promise.all([
          ...
          useAppStore.getState().loadCustomPresentationThemes(),
          ...
          useAppStore.getState().loadDiagramApiSettings(),
          useAppStore.getState().loadInteractiveVideoApiSettings(),
          useAppStore.getState().loadMathApiSettings(),
          useAppStore.getState().loadContentImportApiSettings(),
          useAppStore.getState().loadAssetManagementApiSettings(),
